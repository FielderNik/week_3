...
export type TaskPhase = "research" | "execution" | "validation" | "done";
export type TaskStepStatus = "pending" | "in_progress" | "blocked" | "done" | "failed";

export type TaskStep = {
  id: string;
  phase?: Exclude<TaskPhase, "done">;
  title: string;
  status: TaskStepStatus;
  agentDialogId: string | null;
...
export type TaskState = {
  ...
  isPaused: boolean;
  askBeforeStageTransition?: boolean;
  steps: TaskStep[];
  updatedAt: string;
};
